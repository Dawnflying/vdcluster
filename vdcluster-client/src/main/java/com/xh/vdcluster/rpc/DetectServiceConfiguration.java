...
public class DetectServiceConfiguration implements org.apache.thrift.TBase<DetectServiceConfiguration, DetectServiceConfiguration._Fields>, java.io.Serializable, Cloneable, Comparable<DetectServiceConfiguration> {
  private static final TStruct STRUCT_DESC = new TStruct("DetectServiceConfiguration");

  private static final TField SERVICE_ID_FIELD_DESC = new TField("serviceId", TType.STRING, (short)1);
  private static final TField STREAM_URL_FIELD_DESC = new TField("streamURL", TType.STRING, (short)2);
  private static final TField STREAM_TYPE_FIELD_DESC = new TField("streamType", TType.I32, (short)3);
  private static final TField DECODE_MODE_FIELD_DESC = new TField("decodeMode", TType.I32, (short)4);
  private static final TField FRAME_WIDTH_FIELD_DESC = new TField("frameWidth", TType.DOUBLE, (short)5);
  private static final TField FRAME_HEIGHT_FIELD_DESC = new TField("frameHeight", TType.DOUBLE, (short)6);
  private static final TField DETECT_TYPE_FIELD_DESC = new TField("detectType", TType.LIST, (short)7);
  private static final TField DETECT_SENSITIVITY_FIELD_DESC = new TField("detectSensitivity", TType.MAP, (short)8);

  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new DetectServiceConfigurationStandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new DetectServiceConfigurationTupleSchemeFactory();
  ...
  public java.util.List<Integer> detectType; // required
  public Map<Integer,Double> detectSensitivity; // required
  ...
  public enum _Fields implements TFieldIdEnum {
    ...
    DETECT_SENSITIVITY((short)8, "detectSensitivity");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 7: // DETECT_TYPE
          return DETECT_TYPE;
        case 8: // DETECT_SENSITIVITY
          return DETECT_SENSITIVITY;
        default:
          return null;
      }
    }
  ...
  static {
    ...
    tmpMap.put(_Fields.STREAM_URL, new FieldMetaData("streamURL", TFieldRequirementType.REQUIRED, 
        new FieldValueMetaData(TType.STRING)));
    tmpMap.put(_Fields.STREAM_TYPE, new FieldMetaData("streamType", TFieldRequirementType.REQUIRED, 
        new FieldValueMetaData(TType.I32)));
    tmpMap.put(_Fields.DECODE_MODE, new FieldMetaData("decodeMode", TFieldRequirementType.REQUIRED, 
        new FieldValueMetaData(TType.I32)));
    tmpMap.put(_Fields.FRAME_WIDTH, new FieldMetaData("frameWidth", TFieldRequirementType.REQUIRED, 
        new FieldValueMetaData(TType.DOUBLE)));
    tmpMap.put(_Fields.FRAME_HEIGHT, new FieldMetaData("frameHeight", TFieldRequirementType.REQUIRED, 
        new FieldValueMetaData(TType.DOUBLE)));
    tmpMap.put(_Fields.DETECT_TYPE, new FieldMetaData("detectType", TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(TType.LIST, 
            new FieldValueMetaData(TType.I32))));
    tmpMap.put(_Fields.DETECT_SENSITIVITY, new FieldMetaData("detectSensitivity", TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.MapMetaData(TType.MAP, 
            new FieldValueMetaData(TType.I32), 
            new FieldValueMetaData(TType.DOUBLE))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    FieldMetaData.addStructMetaDataMap(DetectServiceConfiguration.class, metaDataMap);
  }
  ...
  public DetectServiceConfiguration(
    ...
    double frameWidth,
    double frameHeight,
    java.util.List<Integer> detectType,
    Map<Integer,Double> detectSensitivity)
  {
    this();
  ...
  public DetectServiceConfiguration(DetectServiceConfiguration other) {
    ...
    if (other.isSetDetectType()) {
      java.util.List<Integer> __this__detectType = new ArrayList<Integer>(other.detectType);
      this.detectType = __this__detectType;
    }
    if (other.isSetDetectSensitivity()) {
      Map<Integer,Double> __this__detectSensitivity = new HashMap<Integer,Double>(other.detectSensitivity);
      this.detectSensitivity = __this__detectSensitivity;
    }
  }
  ...
  public void unsetStreamType() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __STREAMTYPE_ISSET_ID);
  }

  /** Returns true if field streamType is set (has been assigned a value) and false otherwise */
  public boolean isSetStreamType() {
    return EncodingUtils.testBit(__isset_bitfield, __STREAMTYPE_ISSET_ID);
  }

  public void setStreamTypeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __STREAMTYPE_ISSET_ID, value);
  }
  ...
  public void unsetDecodeMode() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __DECODEMODE_ISSET_ID);
  }

  /** Returns true if field decodeMode is set (has been assigned a value) and false otherwise */
  public boolean isSetDecodeMode() {
    return EncodingUtils.testBit(__isset_bitfield, __DECODEMODE_ISSET_ID);
  }

  public void setDecodeModeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __DECODEMODE_ISSET_ID, value);
  }
  ...
  public void unsetFrameWidth() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __FRAMEWIDTH_ISSET_ID);
  }

  /** Returns true if field frameWidth is set (has been assigned a value) and false otherwise */
  public boolean isSetFrameWidth() {
    return EncodingUtils.testBit(__isset_bitfield, __FRAMEWIDTH_ISSET_ID);
  }

  public void setFrameWidthIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __FRAMEWIDTH_ISSET_ID, value);
  }
  ...
  public void unsetFrameHeight() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __FRAMEHEIGHT_ISSET_ID);
  }

  /** Returns true if field frameHeight is set (has been assigned a value) and false otherwise */
  public boolean isSetFrameHeight() {
    return EncodingUtils.testBit(__isset_bitfield, __FRAMEHEIGHT_ISSET_ID);
  }

  public void setFrameHeightIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __FRAMEHEIGHT_ISSET_ID, value);
  }
  ...
  public java.util.Iterator<Integer> getDetectTypeIterator() {
    return (this.detectType == null) ? null : this.detectType.iterator();
  }

  public void addToDetectType(int elem) {
    if (this.detectType == null) {
      this.detectType = new ArrayList<Integer>();
    }
    this.detectType.add(elem);
  }

  public java.util.List<Integer> getDetectType() {
    return this.detectType;
  }

  public DetectServiceConfiguration setDetectType(java.util.List<Integer> detectType) {
    this.detectType = detectType;
    return this;
  }
  ...
  public int getDetectSensitivitySize() {
    return (this.detectSensitivity == null) ? 0 : this.detectSensitivity.size();
  }

  public void putToDetectSensitivity(int key, double val) {
    if (this.detectSensitivity == null) {
      this.detectSensitivity = new HashMap<Integer,Double>();
    }
    this.detectSensitivity.put(key, val);
  }
  ...
  public DetectServiceConfiguration setDetectSensitivity(Map<Integer,Double> detectSensitivity) {
    this.detectSensitivity = detectSensitivity;
    return this;
  }

  public void unsetDetectSensitivity() {
    this.detectSensitivity = null;
  }

  /** Returns true if field detectSensitivity is set (has been assigned a value) and false otherwise */
  public boolean isSetDetectSensitivity() {
    return this.detectSensitivity != null;
  }

  public void setDetectSensitivityIsSet(boolean value) {
    if (!value) {
      this.detectSensitivity = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case DETECT_TYPE:
      if (value == null) {
        ...
        setDetectType((java.util.List<Integer>)value);
      }
      break;

    case DETECT_SENSITIVITY:
      if (value == null) {
        unsetDetectSensitivity();
      } else {
        setDetectSensitivity((Map<Integer,Double>)value);
      }
      break;
  ...
  public boolean equals(DetectServiceConfiguration that) {
    ...
    boolean this_present_detectSensitivity = true && this.isSetDetectSensitivity();
    boolean that_present_detectSensitivity = true && that.isSetDetectSensitivity();
    if (this_present_detectSensitivity || that_present_detectSensitivity) {
      if (!(this_present_detectSensitivity && that_present_detectSensitivity))
        return false;
      if (!this.detectSensitivity.equals(that.detectSensitivity))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetDetectSensitivity()) ? 131071 : 524287);
    if (isSetDetectSensitivity())
      hashCode = hashCode * 8191 + detectSensitivity.hashCode();
  ...
  public int compareTo(DetectServiceConfiguration other) {
    ...
    lastComparison = Boolean.valueOf(isSetDetectSensitivity()).compareTo(other.isSetDetectSensitivity());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDetectSensitivity()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.detectSensitivity, other.detectSensitivity);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("detectSensitivity:");
    if (this.detectSensitivity == null) {
      sb.append("null");
    } else {
      sb.append(this.detectSensitivity);
    }
    first = false;
    sb.append(")");
    return sb.toString();
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (detectSensitivity == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'detectSensitivity' was not present! Struct: " + toString());
    }
  ...
  private static class DetectServiceConfigurationStandardSchemeFactory implements SchemeFactory {
  ...
  private static class DetectServiceConfigurationStandardScheme extends org.apache.thrift.scheme.StandardScheme<DetectServiceConfiguration> {
            ...
            if (schemeField.type == TType.LIST) {
              {
                ...
                struct.detectType = new ArrayList<Integer>(_list8.size);
                int _elem9;
            ...
            if (schemeField.type == TType.MAP) {
              {
                ...
                struct.detectSensitivity = new HashMap<Integer,Double>(2*_map11.size);
                int _key12;
                double _val13;
                for (int _i14 = 0; _i14 < _map11.size; ++_i14)
                {
                  ...
                  struct.detectSensitivity.put(_key12, _val13);
                }
                iprot.readMapEnd();
              }
              struct.setDetectSensitivityIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DetectServiceConfiguration struct) throws org.apache.thrift.TException {
      ...
      if (struct.detectType != null) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(TType.I32, struct.detectType.size()));
          for (int _iter15 : struct.detectType)
          {
      ...
      if (struct.detectSensitivity != null) {
        oprot.writeFieldBegin(DETECT_SENSITIVITY_FIELD_DESC);
        {
          oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(TType.I32, TType.DOUBLE, struct.detectSensitivity.size()));
          for (Map.Entry<Integer, Double> _iter16 : struct.detectSensitivity.entrySet())
          {
  ...
  private static class DetectServiceConfigurationTupleSchemeFactory implements SchemeFactory {
  ...
  private static class DetectServiceConfigurationTupleScheme extends org.apache.thrift.scheme.TupleScheme<DetectServiceConfiguration> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, DetectServiceConfiguration struct) throws org.apache.thrift.TException {
      ...
      oprot.writeDouble(struct.frameHeight);
      {
        ...
        for (int _iter17 : struct.detectType)
        {
          oprot.writeI32(_iter17);
        }
      }
      {
        oprot.writeI32(struct.detectSensitivity.size());
        for (Map.Entry<Integer, Double> _iter18 : struct.detectSensitivity.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, DetectServiceConfiguration struct) throws org.apache.thrift.TException {
      ...
      struct.setFrameHeightIsSet(true);
      {
        org.apache.thrift.protocol.TList _list19 = new org.apache.thrift.protocol.TList(TType.I32, iprot.readI32());
        struct.detectType = new ArrayList<Integer>(_list19.size);
        int _elem20;
        for (int _i21 = 0; _i21 < _list19.size; ++_i21)
        {
          _elem20 = iprot.readI32();
          struct.detectType.add(_elem20);
        }
      }
      struct.setDetectTypeIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map22 = new org.apache.thrift.protocol.TMap(TType.I32, TType.DOUBLE, iprot.readI32());
        struct.detectSensitivity = new HashMap<Integer,Double>(2*_map22.size);
        int _key23;
        double _val24;
        for (int _i25 = 0; _i25 < _map22.size; ++_i25)
        {
          ...
          struct.detectSensitivity.put(_key23, _val24);
        }
      }
      struct.setDetectSensitivityIsSet(true);
    }
